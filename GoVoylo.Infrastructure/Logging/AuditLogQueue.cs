...
{
    public record AuditLogEntry(Guid? UserId, string EventType);
    ...
    public class AuditLogQueue
    {
        ...
        public void Enqueue(Guid? userId, string eventType)
        {
            _channel.Writer.TryWrite(new AuditLogEntry(userId, eventType));
        }
    }
}
