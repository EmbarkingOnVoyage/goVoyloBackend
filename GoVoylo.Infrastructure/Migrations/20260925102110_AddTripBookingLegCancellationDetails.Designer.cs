...
namespace GoVoylo.Infrastructure.Migrations
{
    ...
    [Migration("20260925102110_AddTripBookingLegCancellationDetails")]
    partial class AddTripBookingLegCancellationDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoVoylo.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.ToTable("gv_audit_logs", (string)null);
                });
            ...
            modelBuilder.Entity("GoVoylo.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4bbebc58-b75d-434d-bb5a-29c6bf7c8fe7"),
                            Name = "customer"
                        },
                        new
                        {
                            Id = new Guid("a04f3f16-299b-4087-a858-d12ca890794b"),
                            Name = "support_agent"
                        },
                        new
                        {
                            Id = new Guid("9ebf67c2-40b6-4481-b580-895303558a69"),
                            Name = "superadmin"
                        });
                });
            ...
            modelBuilder.Entity("GoVoylo.Domain.Entities.SavedTraveler", b =>
                {
                    ...
                    b.Property<bool>("AutoAddTravelInsurance")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.HasIndex("UserId", "FirstName", "LastName", "DateOfBirth")
                        .IsUnique()
            ...
            modelBuilder.Entity("GoVoylo.Domain.Entities.TravelerPassport", b =>
                {
                    ...
                    b.Property<DateTime?>("LastExpiryAlertSentAt")
                        .HasColumnType("timestamptz")
            ...
            modelBuilder.Entity("GoVoylo.Domain.Entities.TripBooking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("gv_trip_bookings", (string)null);
                });

            modelBuilder.Entity("GoVoylo.Domain.Entities.TripBookingLeg", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("gv_trip_booking_legs", (string)null);
                });
            ...
            modelBuilder.Entity("GoVoylo.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<byte[]>("PanCardNumberEncrypted")
                        .HasColumnType("bytea")
                        .HasColumnName("pan_card_number_encrypted");

                    b.Property<DateTime?>("PassportExpiryAlertSentAt")
                        .HasColumnType("timestamptz")
            ...
            modelBuilder.Entity("GoVoylo.Domain.Entities.TripBookingLeg", b =>
                {
                    b.HasOne("GoVoylo.Domain.Entities.TripBooking", null)
                        .WithMany()
